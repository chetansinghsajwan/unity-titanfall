...
class CharacterFactory
{
    ...
    public CharacterFactory(CharacterAsset charAsset)
    {
        _charAsset = charAsset;
    }
    ...
    public virtual void CreatePool()
    {
        ...
        if (_parent is null)
        {
            _parent = new GameObject($"{_charAsset.characterName} Character Pool").transform;
    ...
    {
        var prefab = _charAsset.tppPrefab;
        if (prefab is null)
        {
            return null;
        }
        ...
        initializer.charAsset = _charAsset;
    ...
    public CharacterAsset Source => _charAsset;
