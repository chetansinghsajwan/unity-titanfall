...
public class OpenCharacterController : MonoBehaviour
{
    ...
    public struct CollisionInfo
    {
        ...
        // The direction the character Controller was moving in when the collision occurred.
        ...
        /// <param name="directionMoved">Direction moved when collision occurred.</param>
    ...
    class StuckInfo
    {
                                ...
                                Vector3 originalMoveVector)
        {
            ...
            if (!isStuck)
            {
                // From Quake2: "if velocity is against the original velocity, stop dead to avoid tiny oscillations in sloping corners"
    ...
    [SerializeField, Tooltip("Is the character controlled by a local human? If true then more calculations are done for more accurate movement.")]
    ...
    // Initialize the capsule and rigidbody, and set the root position.
    void Awake()
    {
                                    ...
                                    RaycastHit? hitInfo = null)
    {
        ...
        var overlapCount = UnityEngine.Physics.OverlapCapsuleNonAlloc(GetTopSphereWorldPosition(currentPosition) + offset,
                                                                      ...
                                                                      scaledRadius + tempSkinWidth, m_PenetrationInfoColliders,
                                                                      GetCollisionLayerMask(), m_TriggerQuery);
        ...
        for (var i = 0; i < overlapCount; i++)
        {
            ...
            if (ComputePenetration(offset, collider, colliderTransform.position, colliderTransform.rotation,
